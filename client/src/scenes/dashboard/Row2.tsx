      ...
      <DashboardBox gridArea='d'>
        ...
        <ResponsiveContainer width="99%" height="100%" >
          ...
          >
            ...
            <Tooltip formatter={(v: any) => `$${v.toLocaleString("en-US")}`}/>
            <Line 
              yAxisId='left'
              type="monotone" 
      ...
      <DashboardBox gridArea='e'>
        ...
        <FlexBetween mt='0.25rem' gap='1.5rem' pr='1rem'>
          ...
          <Box ml='-0.7rem' flexBasis='40%' textAlign='center'>
            ...
            <Typography variant='h6'>The desired finance goals of the campaign</Typography>     
          </Box>
          <Box flexBasis='40%'>
            <Typography variant='h5'>Losses in Revenue</Typography>
            <Typography variant='h6'>Losses are down 25%</Typography>
            <Typography mt='0.4rem' variant='h5'>Profit Margins</Typography>     
            <Typography mt='0.4rem' variant='h6'>Margins are up to 30% from last month</Typography> 
          </Box>
        </FlexBetween>
      </DashboardBox>
      <DashboardBox gridArea='f'>
        ...
        <ResponsiveContainer width="99%" height="100%">
          ...
          >
            ...
            <Tooltip labelFormatter={() => { return '' }} formatter={(v) => `$${v}`}  />
            <Scatter 
...
//ZAxis of the 'ScatterChart' is for changing the size of the dots